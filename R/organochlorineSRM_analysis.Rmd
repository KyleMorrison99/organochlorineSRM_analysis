...
# Objective 0. To investigate current literature characteristics such as time trend
## Figure 1 
a) A bar plot showing the time trends of meta-analysis investigating the impacts of organochlorine pesticides. The colours represent the subjects in which the impacts were investigated. 
b) An area plot showing the cummulative time trend of meta-analysis investigating the impacts of organochlorine pesticides. The colours represent the subjects in which the impacts were investigated. 
...
fig1a <- sd_sub %>%
  ...
  geom_text(aes(label = n), position = position_stack(vjust = 0.6), fontface = "bold", color = "white", size = 6, hjust = 0.4) +
  scale_x_continuous(breaks = seq(min(sd1$publication_year), max(sd1$publication_year), by = 1), expand = expansion(0,0)) +  
...
fig1b <-  sd_sub %>%
  ...
  scale_x_continuous(breaks = seq(min(sd_sub$publication_year), max(sd_sub$publication_year), by = 1), expand = expansion(0,0)) +  
  theme_minimal() +
...
## Figure s3 
a) A bar plot showing the time trends of meta-analysis investigating the impacts of organochlorine pesticides. 
b) An area plot showing the cummulative time trend of meta-analysis investigating the impacts of organochlorine pesticides. 
```{r, fig.width=16, fig.height=12}
# Create the annual Count Plot
figs3a <- sd1 %>%
  ...
  geom_text(aes(label = n), position = position_stack(vjust = 0.6), fontface = "bold", color = "white", size = 6, hjust = 0.4) +
  scale_x_continuous(breaks = seq(min(sd1$publication_year), max(sd1$publication_year), by = 1), expand = expansion(0,1)) +
  scale_y_continuous("Annual Article Count", limits = c(0,15)) +
  labs(x = "Year") +
  theme_minimal() +
  theme(panel.grid.major.y = element_line(color = "gray", linetype = "dashed"),
...
figs3
 ggsave(here("figures", "figs3.pdf"), width = 16, height = 12, units = "cm", scale = 2, dpi = 800)
 ggsave(here("figures", "figs3.jpg"), width = 16, height = 12, units = "cm", scale = 2, dpi = 800)
...
## Figure s4 
A bar plot showing the percentage and total count of total of pesticides investigate in meta-analysis investigating the impacts of organochlorine pesticides. note: some meta-analysis may contribute to multiple sections if the study involves multiple organochlorine pesticides
```{r,fig.width=16, fig.height=10}
# Function to change OCP names
...
figs4
 # ggsave(here("figures", "figs4.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
 # ggsave(here("figures", "figs4.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
```

## Figure s5  
A bar plot showing the  percentage and total count of total of subjects investigate in meta-analysis investigating the impacts of organochlorine pesticides 
note: some meta-analysis may contribute to multiple sections if the study involves multiple subjects 
```{r}
...
ggplot(data = df,
       aes(axis1 = ocp, axis2 = subject, axis3 = impact, y = freq)) +
...
ggplot(ocp_im_summary_filtered, 
       aes(x = fct_rev(fct_reorder(impact, count, .fun = 'sum')),
...
## Figure s7 - Total count of each database used to search the literature within each meta-analysis
```{r}
...
# ggsave(here("figures", "figs7.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs7.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
...
ggplot(database_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = database_search)) +
...
# ggsave(here("figures", "figs8.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs8.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
```
...
# Create the Alluvial plot
ggplot(effectsize_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = effect_size)) +
...
# ggsave(here("figures", "figs9.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs9.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
...
ggplot(software_analysis_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = software_analysis)) +
...
# ggsave(here("figures", "figs10.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs10.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
...
# Create the Alluvial plot
ggplot(heterogeneity_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = heterogeneity_assessment_method)) +
...
# ggsave(here("figures", "figs11.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs11.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
...
# Create the Alluvial plot
ggplot(sensitivity_analysis_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = sensitivity_analysis_method)) +
...
# ggsave(here("figures", "figs12.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs12.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
...
# Create the Alluvial plot
ggplot(bias_assessment_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = bias_assessment_type)) +
...
# ggsave(here("figures", "figs13.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs13.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
```
...
# Create the Alluvial plot
ggplot(bias_assessment_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = bias_assessment_method)) +
...
# Create the count plot
figs13 <- bias_visualization_count %>%
  ggplot(aes(x = n, y = reorder(bias_assessment_visualization, n), fill = "#1b9e77")) +
  geom_bar(stat = "identity", width = 0.8 , alpha = 0.7) +
  geom_text(aes(label = n, x = n / 2, y = reorder(bias_assessment_visualization, n)), hjust = 0.5, size = 4, color = "black") +
...
# ggsave(here("figures", "figs14.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs14.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
```
...
# Create the Alluvial plot
ggplot(robmethod_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = rob_assessment_method)) +
...
# ggsave(here("figures", "figs15.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs15.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
```
...
# ggsave(here("figures", "figs16.pdf"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "figs16.jpg"), width = 21, height = 10, units = "cm", scale = 2, dpi = 800)
```
...
# Create the Alluvial plot
ggplot(reporting_standards_alluvial, aes(y = freq ,axis1 = Journal_Category_Allocated_Broad, axis2 = reporting_standards_type)) +
...
effectsize_count <- effectsize_count %>% 
  ...
  mutate(effect_size = if_else(effect_size %in% c("Raw weight", "Transfer rate", "Geometric mean", "Maternal transfer ratio", "SMR (standardized mortality rate)", "Transfer rate"), "Raw comparison", effect_size)) %>% 
  mutate(effect_size = if_else(effect_size %in% c("z-score"), "other", effect_size)) %>% 
  group_by(effect_size) %>%
  summarise(n = sum(n))


# Modifying software_count
...
bias_method_count <- bias_method_count %>% 
  mutate(bias_assessment_method = ifelse(n<= 3, "Other bias assessment", as.character(bias_assessment_method))) %>% 
   group_by(bias_assessment_method) %>%
  summarise(n = sum(n))

sensitivity_count <-  sensitivity_count %>%  
   mutate(sensitivity_analysis_method = ifelse(n<= 3, "Other sensitivity analysis", as.character(sensitivity_analysis_method))) %>% 
   group_by(sensitivity_analysis_method) %>%
  summarise(n = sum(n))

# Modifying risk_of_bias
...
visualization_count <- visualization_count %>% 
  mutate(visualization_method = ifelse(n<= 3, "Other visualization", as.character(visualization_method))) %>% 
  group_by(visualization_method) %>%
  summarise(n = sum(n))
...
df <- bind_rows(
  database_count %>% mutate(methodology_type = 'Database_Search'),
  effectsize_count %>% mutate(methodology_type = 'Effect_Size'),
  ...
  bias_type_count %>% mutate(methodology_type = "Bias_Type"),
  bias_method_count %>%  mutate(methodology_type = "Bias_Assessment"),
  rob_method_count %>% mutate(methodology_type = "Risk_of_Bias"), 
  visualization_count %>% mutate(methodology_type = "Visualization"),
  reporting_guide_count %>%  mutate(methodology_type = "Reporting_Guide"),
  bias_visualization_count %>%  mutate(methodology_type = "Bias Visualization")
) %>% 
...
edges <- df %>%
  rename(from = methodology_type,
         to = methodology_type_specific,
         size = n) %>%
  select(c(from,to,size)) %>%
  as.data.frame()

vertices <- df  %>%
  rename(name = methodology_type_specific,
         size = n) %>%
  select(c(name,size)) %>%
  as.data.frame()
...
fig6 <- ggraph(mygraph, layout = 'circlepack', weight = size) + 
    geom_node_circle(aes(fill = depth)) +
    geom_node_label(aes(label = name, filter = leaf, size = 2)) +
    theme_void() +
    theme(legend.position = "none") +
    scale_fill_gradient(low = "#1b9e77", high = "#894376")


fig6
ggsave(here("figures", "fig6.pdf"), width = 21, height = 15, units = "cm", scale = 2, dpi = 800)
ggsave(here("figures", "fig6.jpg"), width = 21, height = 15, units = "cm", scale = 2, dpi = 800)
```
...
percent_ceesat_score <- sd %>%
  ...
  mutate(percent = (n/sum(n))*100, 
         ...
         question = fct_recode(question, 
           ...
           `5.2. During critical appraisal was an effort made to\nminimise subjectivity?` = "CEESAT2_5.2",
           ...
           `7.2. Is a statistical estimate of pooled effect provided together\nwith measure of variance and heterogeneity among studies?` = "CEESAT2_7.2",
