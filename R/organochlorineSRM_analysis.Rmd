...
fig3e <- heterogeneity_count %>%
  ...
  labs(title = "Heterogeneity Count", x = NULL, y = NULL, tag = "E", size = 30) +
  theme_suppl()
...
fig3f <- sensitivity_count %>%
  ...
  scale_fill_identity(guide = "none") +
  scale_x_continuous(expand = c(0, 0), limits = c(0, max(visualization_count$n)*1.3)) +
  labs(title = "Sensitivity Analysis Count", x = NULL, y = NULL, tag = "F", size = 30) +
  theme_suppl()
...
fig3g <- rob_method_count %>%
  ...
  labs(title = "Risk of Bias Count", x = NULL, y = NULL, tag = "G", size = 30) +
  theme_suppl() 
fig3g
...
fig3h <- bias_method_count %>%
  ...
  labs(title = "Publication Bias Count", x = NULL, y = NULL, tag = "H", size = 30) +
  theme_suppl()
...
fig3i <- bias_visualization_count %>%
  ...
  labs(title = "Bias vizualisation Count", x = NULL, y = NULL, tag = "I", size = 30) +
  theme_suppl()
...
fig3j <- reporting_guide_count %>%
  ...
  scale_fill_identity(guide = "none") +
 scale_x_continuous(expand = c(0, 0), limits = c(0, max(bias_visualization_count$n)*1.3)) +
  labs(title = "Reporting Guideline Count", x = NULL, y = NULL, tag = "J", size = 30) +
  theme_suppl()
...
fig3 <- fig3a + fig3b + fig3c + fig3d + fig3e + 
        fig3f + fig3g + fig3h + fig3i + fig3j +
        plot_layout(ncol = 2, nrow = 5)
fig3

 ggsave(here("figures", "fig3.pdf"), width = 36 , height = 50 , units = "cm", scale = 1, dpi = 400)
 ggsave(here("figures", "fig3.jpg"), width = 36 , height = 50, units = "cm", scale = 2, dpi = 400)
