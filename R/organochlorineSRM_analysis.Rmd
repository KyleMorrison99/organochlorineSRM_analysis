...
bib_alt %>% 
  ...
  geom_point(color = "#5F85AE", alpha = 0.8) +
  labs(x = "Citations", y = "Altmetric Score", title = "Citation vs. Altmetric Score") +
  theme_minimal()
...
# Total CEESAT points vs. Policy count plot
sd_bib_alt %>%
  filter(total_points != 0, policy != 0) %>%
  ggplot(aes(x = total_points, y = policy)) +
  geom_point(color = "#5F85AE", alpha = 0.8) +
  geom_smooth(method = lm, se = TRUE, color = "red") +
  labs(x = "Total CEESAT points", y = "Policy Count") +
  theme_minimal() +
...
# Violin plot for Binary Policy vs. Total CEESAT Points
sd_bib_alt %>%
  ...
  labs( x = "Policy", y = "Total CEESAT Points") +
  theme_minimal() +
  theme(panel.grid.major.y = element_blank(),
        axis.line.y = element_blank(),
        axis.ticks.y = element_blank(),
...
ggplot(data = percent_ceesat_score1, aes(x = question, y = percent, fill = score)) +
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        strip.background = element_blank()) +  # Add this line to remove facet label background
  ylab("Percentage") + 
  xlab("CEESAT Question") +
