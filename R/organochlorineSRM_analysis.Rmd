...
figs6 <- sd_bib_alt_policy %>%
  ...
  geom_jitter(width = 0.1, height = 0.05, color = "#1b9e77", alpha = 0.8) +
...
figsx <- ggplot(data = percent_ceesat_score2, aes(x = question, y = percent, fill = score)) +
  geom_col(width = 0.7, position = "fill", color = "black") +
  geom_text(aes(label = n), position = position_fill(vjust = 0.5), size = 7, fontface = "bold") +
  coord_flip() +
  guides(fill = guide_legend(reverse = TRUE)) +
...
fig3a <- database_count %>%
  ...
  labs(title = "Database Search Count", x = NULL, y = NULL, tag = "A", size = 30) +
  organochlorTHEME() 

fig3a

# ggsave(here("figures", "fig3a.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig3a.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
...
fig3b <- software_count %>%
  ...
  labs(title = "Analysis Software Count", x = NULL, y = NULL, tag = "B", size = 30) +
  organochlorTHEME() 
...
figs8 <- software_analysis_alluvial %>% 
...
fig3c <-  effectsize_count %>%
  ...
  labs(title = "Effect Size Count", x = NULL, y = NULL, tag = "C", size = 30) +
  organochlorTHEME() 
...
fig3d <- visualization_count %>%
  ...
  labs(title = "Visualization Count", x = NULL, y = NULL, tag = "D", size = 30) +
  organochlorTHEME() 
...
# ggsave(here("figures", "fig3e.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig3e.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
...
# ggsave(here("figures", "fig3f.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig3f.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
...
# Create the Alluvial plot
figs12 <- sensitivity_analysis_alluvial %>% 
...
fig3g <- rob_method_count %>%
  ...
  labs(title = "Risk of Bias Count", x = NULL, y = NULL, tag = "C", size = 30) +
  organochlorTHEME() 

fig3g

# ggsave(here("figures", "fig3g.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig3g.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
```
...
# Create the Alluvial plot
figs14 <- bias_assessment_alluvial %>% 
...
# Create the count plot
fig3i <- bias_visualization_count %>%
  ...
  labs(title = "Bias vizualisation Count", x = NULL, y = NULL, tag = "E", size = 30) +
  organochlorTHEME() 

fig3i

# ggsave(here("figures", "fig3i.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig3i.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
```
...
# Create the Alluvial plot
figs15 <- bias_vizualisation_alluvial %>% 
...
fig3d <- reporting_guide_count %>%
  ...
  scale_fill_identity(guide = "none") +
 scale_x_continuous(expand = c(0, 0), limits = c(0, max(bias_visualization_count$n)*1.3)) +
  labs(title = "Reporting Guideline Count", x = NULL, y = NULL, tag = "D", size = 30) +
  organochlorTHEME() 

fig3d

# ggsave(here("figures", "fig3j.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig3j.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
```
...
# Create the Alluvial plot
figs16 <- reporting_standards_alluvial %>% 
...
fig3k <- ggraph(mygraph, layout = 'circlepack', weight = size) + 
...
fig3k
# ggsave(here("figures", "fig3k.pdf"), width = 18, height = 15, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig3k.jpg"), width = 18, height = 15, units = "cm", scale = 2, dpi = 800)
...
# Define your custom color order based on the Dark2 palette
...
fig4 <- ocp_im_summary_filtered %>% 
  ...
  labs(x = "Impact",
       ...
       fill = "Impact") +  # Update legend title
  theme_minimal() +
  theme(
    axis.ticks.y = element_blank(),
    axis.text.x = element_text(size = 20),  
...
# Define colors
my_colors <- c("#1B9E77", "#D95F02", "#7570B3", "#E6AB02", "#A6761D", "#E7298A", "66A61E" )

my_colors <- rep(my_colors, length.out = ncol(merge_matrix2))


jpeg("figures//figs46.jpeg", width = 16, height = 16, units = "cm", res = 300)

# Create a chord diagram of the network matrix
figs46 <- chordDiagram(merge_matrix2, annotationTrack = "grid", 
...
circos.trackPlotRegion(track.index = 1, panel.fun = function(x, y) {
  ...
  ylim = get.cell.meta.data("ylim")
  sector.name = get.cell.meta.data("sector.index")
  circos.text(mean(xlim), ylim[1] , sector.name, facing = "bending.inside", niceFacing = TRUE, adj = c(0.5, 1.25), col = "white", cex = 1.2)
}, bg.border = NA)
...
fields <- sd %>%
  mutate(
    ...
    Journal_Category_Allocated_Broad = str_replace_all(Journal_Category_Allocated_Broad, "Multidisciplinary", "Other"),
    Journal_Category_Allocated_Broad = str_replace_all(Journal_Category_Allocated_Broad, "Marine Biology", "Other"),
    Journal_Category_Allocated_Broad = str_replace_all(Journal_Category_Allocated_Broad, "Psychology", "Other")
...
# Define colors
my_colors2 <- c("#1B9E77", "#D95F02", "#7570B3")
