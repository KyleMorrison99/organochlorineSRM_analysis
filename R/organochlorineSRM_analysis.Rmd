---
title: "Sixty  years since Silent Spring: Sixty years since Silent Spring: a map of meta-analyses on organochlorine pesticides reveals urgent needs for improving methodological quality"
...
figs12 <- database_count %>%
  ...
  labs(title = "Database Search Count", x = NULL, y = NULL, size = 30) +
  organochlorTHEME() 
...
figs14 <- software_count %>%
  ...
  labs(title = "Analysis Software Count", x = NULL, y = NULL, size = 30) +
  organochlorTHEME() 
...
figs16 <-  effectsize_count %>%
  ...
  labs(title = "Effect Size Count", x = NULL, y = NULL, size = 30) +
  organochlorTHEME() 
...
figs18 <- visualization_count %>%
  ...
  scale_fill_identity(guide = "none") +
  scale_x_continuous(expand = c(0, 0), limits = c(0, max(visualization_count$n)*1.3)) +
  labs(title = "Visualization Count", x = NULL, y = NULL, size = 30) +
  organochlorTHEME() 
...
figs20 <- rob_method_count %>%
  ...
  labs(title = "Risk of Bias Count", x = NULL, y = NULL, size = 30) +
  organochlorTHEME() 
...
figs22 <- bias_visualization_count %>%
  ...
  scale_fill_identity(guide = "none") +
  scale_x_continuous(expand = c(0, 0), limits = c(0, max(bias_visualization_count$n)*1.3)) +
  labs(title = "Bias Vizualisation Count", x = NULL, y = NULL, size = 30) +
  organochlorTHEME() 
...
figs22 <- ocp_count %>%
  ...
  labs(title = "Organochlorine Pesticide Count", x = NULL, y = NULL, size = 30) +
  organochlorTHEME() +
...
figs23 <- subject_count %>%
  ...
  labs(title = "Subject Count", x = NULL, y = NULL, size = 30) +
  organochlorTHEME()   
